...
namespace EmployeeWageAssignment
{
    class EmployeeBuilderObject
    {
        ...
        static void Main(string[] args)
        {
            ...
            EmployeeBuilderObject Fauresia = new EmployeeBuilderObject("Fauresia", 2, 3, 5);
            EmployeeBuilderObject IndoShottle = new EmployeeBuilderObject("Indoshottle", 5, 40, 6);
            Fauresia.ComputeEmpWage();
            Console.WriteLine(Fauresia.toString());
            Console.ReadLine();
            IndoShottle.ComputeEmpWage();
            Console.WriteLine(IndoShottle.toString());
